...
func (uc *PositionUsecase) GetAll(ctx context.Context, userID string, paginationCursor int) ([]entity.Position, error) {
	positions, err := uc.repo.FindAll(ctx, userID, paginationCursor)
	if err != nil {
